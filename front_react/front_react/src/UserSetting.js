...
class  UserSetting extends React.Component {
  render() {
    return (
      <div className="modal fade" id="user-modal" tabIndex="-1" role="dialog" aria-labelledby="user-modal-title" aria-hidden="true">
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="user-modal-title">ユーザー情報</h5>
